...
func (c *Config) Flags(prefix string) *pflag.FlagSet { //nolint:funlen // will rework
...
func (c *ClusterOptions) Flags(prefix string) *pflag.FlagSet { //nolint:funlen // will rework
